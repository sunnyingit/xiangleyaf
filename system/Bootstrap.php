...
// 全局常量、函数等
Yaf_Loader::getInstance()->import(APP_PATH . 'conf/constant.php');
Yaf_Loader::getInstance()->import(SYS_PATH . 'Function/Core.php');
...
if (isDebug()) {
    ...
    if (PHP_SAPI !== 'cli') {   // 非命令行模式才输出调试信息
        require_once SYS_PATH . 'Core/Debug.php';
        require_once SYS_PATH . 'Third/FirePHPCore/fb.php';
